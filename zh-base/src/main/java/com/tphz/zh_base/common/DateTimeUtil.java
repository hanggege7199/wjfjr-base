...
public class DateTimeUtil {
    ...
    /***
     * seconds
     * @param totalSecs 00:00
     * @return
     */
    public static String formatSeconds2(long totalSecs) {
    ...
    public static String formatSeconds(long seconds) {
        ...
        if (seconds == 60) {
            ...
            timeStr = "00:" + (seconds > 9 ? seconds : ("0" + seconds));
        }
        if (seconds > 60) {
            long second = seconds % 60;
            long min = seconds / 60;
            timeStr = (min > 9 ? min : ("0" + min)) + ":" + (second > 9 ? second : ("0" + second));
            if (min > 60) {
                min = (seconds / 60) % 60;
        ...
        return timeStr;
        //return  (timeStr > 9 ? duration_m : ("0" + duration_m)) + ":" + (duration_s > 9 ? duration_s : ("0" + duration_s)) ;
    }
}
