...
public class KeyBoardUtil {
    ...
    private static String KEY_BOARD_HEIGHT = "key_board_height";
    ...
    private static SharedPreferences preferences = Constants.getContext().getSharedPreferences(KEY_BOARD_HEIGHT, Context.MODE_PRIVATE);
    private static InputMethodManager imm = (InputMethodManager) Constants.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    public static int[] getScreenSize() {
        int size[] = new int[2];
        DisplayMetrics dm = Constants.getContext().getResources().getDisplayMetrics();
