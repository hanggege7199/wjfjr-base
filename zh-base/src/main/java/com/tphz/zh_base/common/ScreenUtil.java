...
public class ScreenUtil {
    ...
    public static int getStatusBarHeight() {
        int result = 0;
        int resourceId = Constants.getContext().getResources().getIdentifier("status_bar_height", "dimen", "android");
        if (resourceId > 0) {
            result = Constants.getContext().getResources().getDimensionPixelSize(resourceId);
        }
        return result;
    }
    ...
    public static int getPxByDp(float dp) {
        float scale = Constants.getContext().getResources().getDisplayMetrics().density;
